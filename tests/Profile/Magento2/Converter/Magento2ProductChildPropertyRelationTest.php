...
class Magento2ProductChildPropertyRelationTest extends TestCase
{
    /**
    ...
    /**
     * @var Magento23ProductChildPropertyRelationConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Magento23ProductChildPropertyRelationConverter($this->mappingService, $this->loggingService);
    }
