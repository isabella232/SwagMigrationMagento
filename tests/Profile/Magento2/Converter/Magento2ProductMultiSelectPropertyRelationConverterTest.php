...
class Magento2ProductMultiSelectPropertyRelationConverterTest extends TestCase
{
    /**
    ...
    /**
     * @var Magento23ProductMultiSelectPropertyRelationConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Magento23ProductMultiSelectPropertyRelationConverter($this->mappingService, $this->loggingService);
    }
