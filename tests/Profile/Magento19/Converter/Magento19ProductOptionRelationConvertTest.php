...
use Swag\MigrationMagento\Profile\Magento19\Converter\Magento19ProductOptionRelationConverter;
...
class Magento19ProductOptionRelationConvertTest extends TestCase
{
    ...
    /**
     * @var Magento19ProductOptionRelationConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Magento19ProductOptionRelationConverter($this->mappingService, $this->loggingService);
    }
