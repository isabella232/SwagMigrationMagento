...
use Swag\MigrationMagento\Profile\Magento19\Converter\Magento19ProductPropertyRelationConverter;
...
class Magento19ProductPropertyRelationConvertTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Magento19ProductPropertyRelationConverter($this->mappingService, $this->loggingService);
    }
