...
use Swag\MigrationMagento\Profile\Magento19\Converter\Magento19ProductCustomFieldConverter;
...
class Magento19ProductCustomFieldConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->productCustomFieldConverter = new Magento19ProductCustomFieldConverter($mappingService, $this->loggingService);
    }
